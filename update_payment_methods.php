...
$success = 0;
        ...
        if(isset($_POST['submit']))
        {
            ...
            $sql = "UPDATE `payment_methods` SET id = $id,  `card_number` = '$cardnumber', `exp_date` = '$date' ,`cvv` = '$cvv' where id = $id";
...
<body>
    ...
    <div class="container">
        ...
        <form class="card-info-form" method="post">
            ...
            <button name="submit" type="submit" class="pay-button">Save</button>
        </form>
